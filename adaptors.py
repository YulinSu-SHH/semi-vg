...
class PretrainAdaptor(object):
    ...
    def __call__(self, batch, model_outputs):
        ...
        loss, batch_loss,sample_size, batch_size,logging_output,batch_loss2 = criterion(model_outputs, batch)
        
        outputs["losses"] = loss
        outputs["batch_losses"] = batch_loss
        outputs["sample_size"] = sample_size
        outputs["batch_size"] = batch_size
        outputs["batch_losses2"] = batch_loss2
