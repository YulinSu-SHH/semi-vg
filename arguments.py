...
def add_training_args(parser):
    ...
    group.add_argument('--pseudo-out-root',
                       type=str,
                       default='',
                       help='where to store pseudo labels')    
    group.add_argument('--image-root',
                       type=str,
                       default='')   
...
def add_data_args(parser):
    ...
    group.add_argument("--text-data", type=str, default="")
    group.add_argument("--detection-data", type=str, default="")
    group.add_argument("--image-data", type=str, default="")
...
def add_custom_args(parser):
    ...
    group.add_argument('--metric_gc',
                       type=str,
                       default='accuracy',
                       help='metric to save the best ckpt')
    group.add_argument('--metric_vg',
                       type=str,
                       default='accuracy',
                       help='metric to save the best ckpt')
