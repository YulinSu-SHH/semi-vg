...
# init_method="random"
load=/mnt/lustre/share_data/suyulin/save_model/multi-tiny-scratch-2/pretrain/1228_1633/gs13209
# /mnt/lustre/share_data/suyulin/hf_ofa_tiny
# /mnt/lustre/share_data/suyulin/save_model/multi-tiny-scratch/pretrain/1228_1130/gs3145
# "/mnt/lustre/share_data/suyulin/hf_ofa_tiny"

data_dir=/mnt/lustre/share_data/suyulin/VG/
DATA=${data_dir}/refcocog/refcocog_label.tsv,${data_dir}/refcocog/refcocog_unlabel_small.tsv,${data_dir}/refcocog/refcocog_test_u.tsv
jobname=pseudo_filter_iou
...
mkdir -p $save_path
image_root=${data_dir}/pseudo_filter_iou
...
# pseudo
pseudo_out_root=${data_dir}/pseudo_filter
mkdir -p $pseudo_out_root

srun -p rdbp1_v100_32g -n1 -N 1 --gres=gpu:4 --job-name=${jobname} --comment wbsR-SC221419.001 \
