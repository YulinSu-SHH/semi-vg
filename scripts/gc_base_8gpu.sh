...
init_method="random"
load="/mnt/lustre/suyulin/debug/ofa-hf-master/save_model/gc/caption_stage1/1220_1445/gs16218"
# load="/mnt/lustre/suyulin/ofa-hf/ofa/hf_ofa_base/"
...
DATA=${data_dir}/refcocog/refcocog_label.tsv,${data_dir}/refcocog/refcocog_unlabel.tsv,${data_dir}/refcocog/refcocog_test.tsv
jobname=gc
...
srun -p rdbp1_v100_32g -n1 -N 1 --gres=gpu:8 --job-name=${jobname} --comment wbsR-SC221419.001 \
