...
class EnsembleModel(nn.Module):
    ...
    def has_encoder(self):
        # return hasattr(self.single_model.module, "encoder")
    ...
    def forward_encoder(self, net_input: Dict[str, Tensor]):
        ...
        # return [model.module.encoder.forward(**encoder_input) for model in self.models]
    ...
    def forward_decoder(
        ...
        for i, model in enumerate(self.models):
            if self.has_encoder():
                ...
                # attention_mask = tokens.eq(self.single_model.module.padding_idx)
                attention_mask = tokens.eq(self.single_model.padding_idx)

            # decode each model
            if self.has_incremental_states():
                # decoder_out = model.module.decoder.forward(
                ...
                if hasattr(model, "decoder"):
                    ...
                    # decoder_out = model.module.forward(tokens)
            ...
            # probs = model.module.get_normalized_probs(
    ...
    def reorder_encoder_out(
        ...
        for i, model in enumerate(self.models):
            ...
            new_outs.append(
                ...
                # model.module.encoder.reorder_encoder_out(encoder_outs[i], new_order)
            )
        return new_outs
    ...
    def reorder_incremental_state(
        ...
        if not self.has_incremental_states():
            return
        for i, model in enumerate(self.models):
            # model.module.decoder.reorder_incremental_state_scripting(
